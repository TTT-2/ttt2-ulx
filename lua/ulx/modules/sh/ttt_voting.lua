...
if SERVER then 
    ulx.convar("voteslaynrSuccessratio", "0.6", _, ULib.ACCESS_ADMIN) -- The ratio needed for a voteslaynr to succeed
end

if SERVER then 
    ulx.convar("voteslaynrMinvotes", "1", _, ULib.ACCESS_ADMIN) -- Minimum votes needed for voteslaynr
end
...
if SERVER then 
    ulx.convar("votefsSuccessratio", "0.6", _, ULib.ACCESS_ADMIN) -- The ratio needed for a votefs to succeed
end

if SERVER then 
    ulx.convar("votefsMinvotes", "1", _, ULib.ACCESS_ADMIN) -- Minimum votes needed for votefs
end
